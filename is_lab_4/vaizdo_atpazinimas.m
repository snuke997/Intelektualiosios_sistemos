...
T = [eye(5), eye(5), eye(5), eye(5), eye(5), eye(5)];
% sukuriamas SBF1tinklas duotiems P ir T sàryðiams
% create an RBF network for classification with 13 neurons, and sigma = 1
tinklas = newrb(P,T,0,25,25);
